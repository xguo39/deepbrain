...
class Phenotype_match_table extends React.Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return (
      <div className='phenotype_match_table'>
        <div>
          <Table.Provider
...
Phenotype_match_table.propTypes={

}

Phenotype_match_table.defaultProps={

}

export default Phenotype_match_table;
