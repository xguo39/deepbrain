...
class Incidental_finding_table extends React.Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return(
      <div className='incidental_finding_table'>
        <div>
          <Table.Provider
...
Incidental_finding_table.propTypes={

}

Incidental_finding_table.defaultProps={

}

export default Incidental_finding_table;
