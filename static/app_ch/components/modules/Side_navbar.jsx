      ...
      <nav className='col-sm-2 sidebar'>
        ...
        <ul className='nav flex-column'
          ...
          <li className='nav-item'>
            <Link to='/home/ch' className='nav-link sidebar-link'>
              <img src={static_image + "newtask-icon.png"} alt='new_task'></img>
              <span>新任务</span>
            </Link>
          </li>
          <li className='nav-item'>
            <Link to='/home/ch/task_list' className='nav-link sidebar-link'>
              <img src={static_image + "tasklist-icon.png"} alt='task-list'></img>
              <span>任务列表</span>
            </Link>
          </li>
          <li className='nav-item'>
            <Link to='/home/ch/review_list' className='nav-link sidebar-link'>
